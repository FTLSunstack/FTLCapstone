    ...
    return (
        <div className="LoginForm bg-white bg-center flex flex-col items-center w-100 h-140 rounded-md "> 
            ...
            <container className= "flex flex-col items-left">
                <p className="mt-4 ml-1 text-center text-indigo-600 hover:text-purple-800 transition ease-in-out hover:cursor-pointer"> Forgot password?</p>
                <button onClick={handleBack} className="mt-2 mb-4 py-2 px-30 text-center font-semibold rounded-lg shadow-md text-white bg-indigo-700 hover:bg-blue-800 cursor-pointer"> Sign In</button>
            </container>
